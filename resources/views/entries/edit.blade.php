    ...
    <div class="col-md-6 createForm">
      ...
      <form method="post" action="{{ route('entries.update', $entry->id) }}" enctype="multipart/form-data">
        ...
        <div class="form-group row">
          ...
          <div class="col-9">
            <input type="text" name="title" class="form-control" value="{{ $entry->title }}" id="" placeholder="Entry title">
          </div>
        </div>
        <div class="form-group row">
          <label for="body" class="col-3 control-form-label col-form-label-md">Body</label>
          <div class="col-9">
            <textarea name="body" id="" rows="6" class="form-control" placeholder="Entry details">{{ $entry->body }}</textarea>
          </div>
        </div>
        <div class="form-group row">
        ...
        <div class="form-group row">
          <div class="offset-md-2 col-md-10">
            <button type="submit" class="btn btn-outline-success link-btn">Update</button>
          </div>
        </div>
